  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input id={inputId} className={`w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-stone-900 placeholder:text-stone-400 outline-none transition-shadow focus:ring-2 focus:ring-brand-400/40 focus:border-brand-400 ${icon ? 'pl-9' : ''} ${error ? 'border-red-400' : 'border-stone-200'} ${className}`} {...rest} />
      </div>
